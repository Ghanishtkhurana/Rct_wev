      ...
      <Flex>
        ...
        <Flex m={9}>
          <Menu>
            ...
            <MenuList>
              <Link to="/make_up"><MenuItem>Make Up</MenuItem></Link>
              <Link to="/skin"><MenuItem>Skin</MenuItem></Link>
              <Link to="/hair"><MenuItem>Hair</MenuItem></Link>
              <Link to="/ayurveda"><MenuItem>Ayurveda</MenuItem></Link>
              <Link to="/personal_care"><MenuItem>Personal Care</MenuItem></Link>
              <Link to="/fragnance"><MenuItem>Fragnance</MenuItem></Link>
              <Link to="/mom&baby"><MenuItem>Mom & Baby Care</MenuItem></Link>
            </MenuList>
          </Menu>
          ...
          <Input
            ...
            borderRightRadius="0"
          />
          <Button bgColor={"rgb(221,2,133)"} borderLeftRadius="0">
            <SearchIcon />
          </Button>
        </Flex>
            ...
            {({ isOpen }) => (
              <>
                ...
                <MenuList>
                  ...
                  <MenuItem onClick={handleTheRegister}>
                    Register
                  </MenuItem>
                </MenuList>
              </>

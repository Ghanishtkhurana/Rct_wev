...
// const getData = () => {
//   return axios("https://khurana123.herokuapp.com/data?_limit=12&type=perfume");
// };

const getData = async() => {
  const res = await fetch("https://khurana123.herokuapp.com/data?_limit=12&type=perfume")
